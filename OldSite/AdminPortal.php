...
function insertSingle() {
	...
	var proof = prompt("Is the drink alcoholic? (1 or 0): ");

	$.get("InsertSingle.php?drinkName=" + name + "&proof=" + proof);
	alert("Inserting " + name + " into singles database where alcoholic = " + proof);
}
